const defaultProjects = {
    'projects': [
        {
            'projectName': 'Simple Network Design',
            ...
            'json': '/defaultProjects/SimpleNetworkDesign.json'
        },
        {
            'projectName': 'Advanced Network Design',
            ...
            'json': '/defaultProjects/AdvancedNetworkDesign.json'
        },
    ],
}
